...
<template>
  <div class="drawer lg:drawer-open">
    ...
    <div class="drawer-content">
      <nav class="navbar w-full bg-base-100 shadow-xl">
        ...
        <div class="navbar-center absolute left-1/2 -translate-x-1/2">
          <div class="join">
            <input class="input join-item rounded-l-full w-96" placeholder="搜索你感兴趣的内容" />
        ...
        <div class="navbar-end">
          <RouterLink v-if="user.isLogin()" :to="{name:'update-character',params:{character_id:1}}" active-class="btn" class="btn btn-ghost text-base mr-6">
            <CreateIcon/>
              创作
          </RouterLink>
          <RouterLink v-if="user.hasPulledUserInfo && !user.isLogin()" :to="{name:'user-account-login-index'}" active-class="btn-active" class="btn btn-neutral btn-outline">
            登录
          </RouterLink>
